            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        @if($product->sale_price > 0 && $sale->status==1 && $sale->sale_data>Carbon\Carbon::now())
                        <div class="wrap-price"><span class="product-price">{{$product->sale_price}}</span></div>
                        <del><span class="product-price">{{$product->price}}</span></del>
                        @else 
                        ...
                        <div class="wrap-butons">
                            <a href="{{route('product.detail',['slug'=>$product->slug])}}" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->price}})">Add to Cart</a>
                            <div class="wrap-btn">
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    <a href="detail.html" title="{{$p->name}}">
                                        <figure><img src="{{ asset('assets/images/products') }}/{{$p->image}}" width="214" height="214" alt="{{$p->name}}"></figure>
                                    </a>
