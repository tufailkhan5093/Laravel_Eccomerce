        ...
        <div class=" panel panel-head">
            <div class="col-md-10 container containerr mt-4">
                <div class="row" style="padding-top: 30px">
                    <div class="col-md-6">
                        <h3 style="margin-left: 20px">Edit Home Slide</h3>
                    </div>
               ...
               <br><br>
                   ...
                   <form  class="form-group" enctype="multipart/form-data" wire:submit.prevent="EditSlider()">
                        ...
                        <input wire:model="new_image"  type="file" placeholder="Image" class="form-control"><br>
                        @if($new_image)
