    ...
    .fill-heart{
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                ...
                                <div class="product-info">
                                    ...
                                    <a href="" wire:click.prevent="removeWishlist({{$product->id}})"><i class="fa fa-heart fill-heart fa-3x"></i></a>
                                    @else 
                                    <a wire:click.prevent="addtoWishlist('{{$product->id}}','{{$product->name}}',{{$product->price}})" href=""><i class="fa fa-heart before fa-3x"></i></a>
                                    @endif
                ...
                <div class="wrap-pagination-info" style="background-color: rgb(235, 77, 77)">
