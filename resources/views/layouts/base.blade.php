...
<body class="home-page home-01 ">
                                ...
                                @if(Route::has('login'))
                                    ...
                                    @if(Auth::user()->utype==='ADM')
                                        <li class="menu-item menu-item-has-children parent" >
                                            <a title="MyAcount" href="#">My Account {{Auth::user()->name}}<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                            <ul class="submenu curency" >
												...
												<li class="menu-item" >
                                                    <a title="Manage HomeSlide" href="{{route('admin.homeslider')}}">Manage Home Slider</a>
                                                </li>

												<li class="menu-item" >
                                                    <a title="Manage HOme Category" href="{{route('admin.homecategory')}}">Manage Home Categories</a>
                                                </li>
												...
												<li class="menu-item" >
                                                    <a title="Manage HOme Category" href="{{route('admin.salesetting')}}">Sale Setting</a>
                                                </li>
												...
												<li class="menu-item" >
                                                    <a title="All Coupons" href="{{route('admin.contact')}}">Contact Message</a>
                                                </li>

												<li class="menu-item" >
                                                    <a title="All Coupons" href="{{route('admin.setting')}}">Setting</a>
                                                </li>
	...
	<script src="https://cdn.tiny.cloud/1/z3rp6mo7x4agqidesdfy4q9yu1dxjexyy7lty7yevz1yczoi/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
